...
var _database = require("./node_modules/firebase/database");
...
function addComment(blogTitle, name, comment) {
  ...
  dayjs.utc();
  const now = dayjs();
  (0, _database.set)((0, _database.ref)(database, 'comments/' + `${hashCode(blogTitle)}}/` + now), {
    blog: blogTitle,
    name: name,
    comment: comment,
...
if (commentsForm) {
  commentsForm.addEventListener('submit', event => {
    ...
    commentsForm.reset();
    const dbRef = (0, _database.ref)((0, _database.getDatabase)(app));
    (0, _database.get)((0, _database.child)(dbRef, `comments/${hashCode(blogTitle)}}`)).then(snapshot => {
      if (snapshot.exists()) {
...
function addContactRequest(name, email, message) {
  ...
  dayjs.utc();
  const now = dayjs();
  (0, _database.set)((0, _database.ref)(database, 'contact/' + now), {
    name: name,
    email: email,
    message: message,
    createdAt: now.format('MMMM D, YYYY h:mm:ss A')
...
},{"./node_modules/firebase/app":9,"./node_modules/firebase/database":10,"dayjs":7,"dayjs/plugin/utc":8}],2:[function(require,module,exports){
"use strict";
...
},{"@firebase/component":3,"@firebase/logger":5,"@firebase/util":6,"idb":11}],3:[function(require,module,exports){
"use strict";
 ...
 */function getDatabase(app=(0,_app.getApp)(),url){return(0,_app._getProvider)(app,'database').getImmediate({identifier:url});}/**
...
},{"@firebase/app":2,"@firebase/component":3,"@firebase/logger":5,"@firebase/util":6,"_process":13}],5:[function(require,module,exports){
"use strict";
...
},{"./wrap-idb-value.js":12}],12:[function(require,module,exports){
"use strict";
